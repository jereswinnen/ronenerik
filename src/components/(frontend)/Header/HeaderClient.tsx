...
export const HeaderClient: React.FC<HeaderClientProps> = ({
  ...
  return (
    <>
      ...
      {/* Menu overlay */}
      {isOpen && (
        <div className="fixed inset-0 top-16 z-40 bg-c-background/95 backdrop-blur-lg overflow-y-auto">
          <div className="container py-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Column 1: Podcast */}
              <div className="rounded-xl border border-c-foreground/10 bg-c-foreground/5 p-5">
