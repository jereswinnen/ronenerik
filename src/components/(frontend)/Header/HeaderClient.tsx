      ...
      <div className="fixed top-4 inset-x-0 z-50 container">
        ...
        >
          <div className="rounded-xl bg-c-background/85 backdrop-blur-lg overflow-hidden">
            ...
            {/* Menu content — grid row animation for natural height */}
            <div
              className="grid transition-[grid-template-rows] duration-500 ease-in-out"
              style={{
                gridTemplateRows: isOpen && isVisible ? '1fr' : '0fr',
              }}
            >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          transition: `opacity 400ms ease ${isVisible ? '150ms' : '0ms'}, transform 400ms ease ${isVisible ? '150ms' : '0ms'}`,
                        }}
                      >
                        ...
                        <div className="flex items-center justify-between mt-3">
                          <div className="flex gap-3">
                            {siteSettings?.externalLinks?.youtubeChannelUrl && (
                              <SocialIcon
                                href={siteSettings.externalLinks.youtubeChannelUrl}
                                label="YouTube"
                              >
                      ...
                      <div
                        ...
                        style={{
                          opacity: isVisible ? 1 : 0,
                          transform: isVisible ? 'translateY(0)' : 'translateY(8px)',
                          transition: `opacity 400ms ease ${isVisible ? '250ms' : '0ms'}, transform 400ms ease ${isVisible ? '250ms' : '0ms'}`,
                        }}
                      >
                        <span className="text-xs font-medium uppercase tracking-wider text-c-foreground/60 mb-3 block">
                          Artikelen
                      ...
                      <div
                        ...
                        style={{
                          opacity: isVisible ? 1 : 0,
                          transform: isVisible ? 'translateY(0)' : 'translateY(8px)',
                          transition: `opacity 400ms ease ${isVisible ? '350ms' : '0ms'}, transform 400ms ease ${isVisible ? '350ms' : '0ms'}`,
                        }}
                      >
...
function SpotifyIcon() {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="text-c-foreground/60 hover:text-c-foreground transition-colors"
    >
